package com.meditatenowKidStress.api;
...
public class MNAudioManager {
	...
	public MNAudioManager() {
		...
		addAudio(R.raw.two_kid_stress_instruction, (5*60 + 3)*1000 + 500, "2. Kid Stress Instructions.mp3", "Focus...");
		addAudio(R.raw.three_kid_stress_lesson, (1*60 + 23)*1000 + 500, "3. Kid Stress Lesson.mp3", "Breathe...");
	}
